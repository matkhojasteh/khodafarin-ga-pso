function y=Mutate1(x,mu)
   ...
   load('var.mat','Wmin_berms');
    ...
    max1=484.5-(30-x(2,1))/tan(1.107);
    max2=max1-2;
    max3=max2-(x(2,2)-x(2,3))/tan(1.107);
     VarMax.x=[max1 max2 max3];
    min1=484.5-(30-x(2,1))/tan(.1974);
    min2=min1-2;
    min3=min2-(x(2,2)-x(2,3))/tan(.1974);
     VarMin.x=[min1 min2 min3];    
